class Bubble {
  constructor(t, l, x, y) {
    ...
    this.noiseT2X = random(10);
    this.noiseT2Y = random(10);
    this.text = t;
	...
	display() {
	  	...
	  	if(this.visible) {
			if (this.hasChilds != 0) {
				...
				ellipse(this.factorX, this.factorY, this.bgSize +1, this.bgSize +1);
				this.noiseTX += 0.005;
				this.noiseTY += 0.005;
				this.factorX = map(noise(this.noiseT2X), 0, 1, this.posX - 10, this.posX + 10);
				this.factorY = map(noise(this.noiseT2Y), 0, 1, this.posY - 10, this.posY + 10);
				//ellipse(this.factorX, this.factorY, this.bgSize * 1.2, this.bgSize * 1.2);
				ellipse(this.factorX, this.factorY, this.bgSize +5, this.bgSize +5);
				this.noiseT2X += 0.01;
				this.noiseT2Y += 0.01;
			}
